        ...
        contents: [
            {
                ...
                content: `単層CNTはナノサイズかつ擬一次元的な構造を持つことから，通常のバルク物質とは異なる光物性を持ち，物理的に興味深い研究対象です． 同時に，分析ツールとしての確立や，光デバイスへの応用のためにも，単層CNTの分光法の研究が求められています．本研究室では，蛍光分光法，光吸収分光法，ラマン散乱分光法，レイリー散乱分光法などを用いて単層CNTの光物性を研究しています．特に，空洞になっているその内部空間に着目し，分子の出入りや閉じ込め，輸送現象や，ナノスケールに閉じ込められた物質の物理・化学現象について研究を進めています．`,
            },
            {
                index: 1,
                name: 'vdw',
                title: `グラフェンなど二次元層状物質の合成，ナノ構造構築技術`,
                content:`グラフェンは炭素原子1層からなる二次元物質で，が2010年にノーベル賞を受賞するなど，近年非常に注目されています． セロハンテープでグラファイトを剥離することで数μm程度のグラフェンのかけらを得ることができますが，工業的な応用のためにはより大面積にグラフェンを作製する必要があります．私たちはCVD法を用いて，大面積の単結晶単層グラフェンや，グラフェンと似た構造の六方窒化ホウ素（h-BN）や遷移金属ダイカルゴゲナイト（TDMC）などの積層構造の合成や，転写法により様々なナノスケールの構造体の構築を目指しています．`,
            },
            {
                index: 2,
                name: 'film',
                title: `カーボンナノチューブ導電性材料の開発`,
                content: `CNTは優れた電気伝導を持ちますが，多数のCNTを束にしたファイバー構造や平面状に集めた薄膜構造を形成すると，抵抗が大きくなることが知られています．そこで，高電気伝導性を維持したファイバーや薄膜を得るための新しい成形技術を探索しています．低抵抗なCNTファイバーは銅線などの代替に，CNT薄膜はフレキシブルな透明導電膜としての応用が期待できます．`,
            },
        ],
    },
    'English': {
